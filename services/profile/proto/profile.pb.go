...
const file_proto_profile_proto_rawDesc = "" +
	...
	"\x12not_found_user_ids\x18\x02 \x03(\tR\x0fnotFoundUserIds2\x8f\x02\n" +
...
var file_proto_profile_proto_goTypes = []any{
	...
	(*BatchProfilesBriefRequest)(nil),  // 4: profile.BatchProfilesBriefRequest
	(*ProfileBrief)(nil),               // 5: profile.ProfileBrief
	(*BatchProfilesBriefResponse)(nil), // 6: profile.BatchProfilesBriefResponse
}
var file_proto_profile_proto_depIdxs = []int32{
	5, // 0: profile.BatchProfilesBriefResponse.items:type_name -> profile.ProfileBrief
	0, // 1: profile.ProfileService.CreateProfile:input_type -> profile.CreateProfileRequest
	2, // 2: profile.ProfileService.DeleteProfile:input_type -> profile.DeleteProfileRequest
	4, // 3: profile.ProfileService.BatchProfilesBrief:input_type -> profile.BatchProfilesBriefRequest
	1, // 4: profile.ProfileService.CreateProfile:output_type -> profile.CreateProfileResponse
	3, // 5: profile.ProfileService.DeleteProfile:output_type -> profile.DeleteProfileResponse
	6, // 6: profile.ProfileService.BatchProfilesBrief:output_type -> profile.BatchProfilesBriefResponse
